...
cv_results_df.to_csv(save_path + '\\' + 'svm_cv_results_thoughts.csv', index = False)
...
#print(" AUPRC:")
#print("Class 0 AUPRC: ", mean(nested_score['test_aucpr_class_0']) )
#print("Class 1 AUPRC: ", mean(nested_score['test_aucpr_class_1']) )
#print("Class 2 AUPRC: ", mean(nested_score['test_aucpr_class_2']) )
...
#print("Macro AUPRC: ", mean(nested_score['test_aucpr_macro']) )
print("######")
...
cv_results_df = pd.DataFrame.from_dict(estimator_results)
cv_results_df.to_csv(save_path + '\\' + 'random_forest_cv_results_thoughts.csv', index = False)
...
## Convert cv_results_ to DataFrame and print
cv_results_df = pd.DataFrame.from_dict(estimator_results)
cv_results_df.to_csv(save_path + '\\' + 'naive_bayes_cv_results_thoughts.csv', index = False)
...
## Convert cv_results_ to DataFrame and print
cv_results_df = pd.DataFrame.from_dict(estimator_results)
cv_results_df.to_csv(save_path + '\\' + 'xgboost_cv_results_thoughts.csv', index = False)
...
## Convert cv_results_ to DataFrame and print
cv_results_df = pd.DataFrame.from_dict(estimator_results)
cv_results_df.to_csv(save_path + '\\' + 'mlp_cv_results_thoughts.csv', index = False)
